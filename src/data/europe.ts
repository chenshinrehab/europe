...
export const europeCountries: Record<string, CountryItem> = {
  ...
  france: {
    ...
    title: '浪漫法蘭西尊榮之旅',
    countryName: '法國',
    subtitle: 'France Premium Tour',
    description: '探索巴黎的藝術靈魂與南法的鄉間風情。',
    image: '/images/europe/france-hero.webp',
    spots: [
      {
        id: 'paris',
        name: '花都 - 巴黎',
        description: '從艾菲爾鐵塔到羅浮宮，專車接送讓您的購物與觀光行程從容不迫。',
        image: '/images/spots/paris.webp',
      }
    ]
  }
};