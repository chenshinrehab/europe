...
export const europeCountries: Record<string, CountryItem> = {
  ...
  spainPortugal: {
    id: 'spainPortugal',
    title: '葡西雙國：熱情伊比利深度巡禮',
    countryName: '葡西',
    subtitle: 'Iberian Peninsula Heritage',
    description: '從巴塞隆納的高第奇蹟，到葡萄牙的湛藍海岸。我們帶您穿梭於摩爾式宮殿與白色山城，感受伊比利半島獨有的熱情節奏與輝煌歷史。',
    image: '/images/europe/spain-portugal-hero.webp',
    spots: [
      {
        id: 'sagrada-familia',
        name: '高第奇蹟 - 聖家堂',
        description: '巴塞隆納永恆的信仰地標。這座至今仍在建造的建築神作，透過森林般的石柱與炫彩玻璃，展現了高第對自然與上帝的終極致敬。',
        image: '/images/europe/spainPortugal/1.webp',
      },
      {
        id: 'alhambra',
        name: '伊斯蘭遺珠 - 阿爾罕布拉宮',
        description: '矗立於格拉納達的摩爾皇宮。細緻入微的灰泥雕刻、靜謐的庭院水池，在夕陽映射下訴說著昔日阿拉伯王國的哀愁與壯麗。',
        image: '/images/europe/spainPortugal/2.webp',
      },
      {
        id: 'pena-palace',
        name: '繽紛幻境 - 佩納宮',
        description: '位於辛特拉山巔的浪漫主義傑作。亮麗的紅黃對比色、奇幻的雕飾元素，宛如童話書中跳脫出的夢幻宮殿，俯瞰著大西洋的氣息。',
        image: '/images/europe/spainPortugal/3.webp',
      },
      {
        id: 'algarve',
        name: '絕美岩灘 - 阿爾加維海岸',
        description: '葡萄牙南端的世界級海景。奇特的海蝕洞穴、金黃色的斷崖與清澈透明的海水，是遠離塵囂、享受地中海陽光的絕佳避風港。',
        image: '/images/europe/spainPortugal/4.jpg',
      },
      {
        id: 'ronda',
        name: '斷崖古城 - 龍達與白色山城',
        description: '坐落於百米峽谷之上的白色城鎮。橫跨深谷的新橋連接了新舊城區，展現了西班牙安達魯西亞地區最震撼的地理景致。',
        image: '/images/europe/spainPortugal/5.webp',
      },
      {
        id: 'quinta-da-regaleira',
        name: '神祕莊園 - 雷加萊拉莊園',
        description: '辛特拉最具神祕色彩的迷宮莊園。沿著螺旋地底深井拾級而下，在隱密的隧道與噴泉間探索充滿煉金術與占星學色彩的奇幻世界。',
        image: '/images/europe/spainPortugal/6.webp',
      }
    ]
  }
};